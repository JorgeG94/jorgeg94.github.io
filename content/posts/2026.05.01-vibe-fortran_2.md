...
Also, if you handle memory by allocating it all at once and keeping track of the arrays you are using then you can go with the assumption that all necessary data is already on the GPU. So you can write "normal" code.
